...
NEW = '''    @staticmethod
    def send_email(
        ...
        - When smtp_provider is explicitly assigned and
          non-blank, that provider is used for both SMTP
          configuration validation and SMTP connection.

        - When smtp_provider is missing or blank, the
          original zero-argument legacy SMTP path is
